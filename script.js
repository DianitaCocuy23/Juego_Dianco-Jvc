...
const preguntas = [
    ...
    {
        id: 8,
        encabezado: "¿Cómo se llama y dónde está ubicada esta impresionante roca?",
        opciones: [
            {
                id: 1,
                respuesta: "Piedra del Tunjo, Facatativá, Departamento de Antioquia",
                correcto: false
            },
            {
                id: 2,
                respuesta: "Piedra del Tunjo, Facatativá, Departamento de Cundinamarca",
                correcto: false
            },
            {
                id: 3,
                respuesta: "Piedra del Peñol, en Guatapé, Departamento de Antioquia",
                correcto: true
            },
            {
                id: 4,
                respuesta: "El tabor, en San Carlos, Departamento de Antioquia",
                correcto: false
            }
        ]
    },
...
async function calcularPuntaje() {
    ...
    alert("tu puntajes es" + puntosTotales + "de 1000" + " Deseas volver a intentarlo?")
